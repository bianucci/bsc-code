...
public class RegisterConfigID implements Serializable {
	private static final long serialVersionUID = -6874230656989830560L;

	int nRegler_id;
	int nRegisternr;

	public RegisterConfigID() {
	}

	public RegisterConfigID(int nRegler_id, int nRegisternr) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RegisterConfigID other = (RegisterConfigID) obj;
